...
CREATE TABLE `applications` (
  ...
  `ui_url` varchar(250) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'https://ui.argoflow.io',
  `ui_password_reset_url` varchar(250) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'https://ui.argoflow.io/reset-password?security-code=%s',
  PRIMARY KEY (`id`)
